...
const FullscreenModal = ({ isOpen, onClose, onExited, title, children }: FullscreenModalProps) => {
  ...
  return (
    <div className={`fullscreen-modal ${animationState}`} onAnimationEnd={handleAnimationEnd}>
      <div className="fullscreen-modal__content">
        <header className="fullscreen-modal__header">
          <button className="fullscreen-modal__close" onClick={onClose} aria-label="Close modal">
            <CloseIcon />
          </button>
