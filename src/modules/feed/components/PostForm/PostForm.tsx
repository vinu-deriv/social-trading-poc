  ...
  return (
    <form className="post-form" onSubmit={handleSubmit}>
      <div className="post-form__header">
        ...
        />
        <span className="post-form__user-name">{currentUser.username}</span>
      </div>
      <textarea
      ...
      {images.length > 0 && (
        <div className="post-form__image-preview">
          {images.map((image, index) => (
            <div key={index} className="post-form__image-container">
              <img src={image} alt={`Preview ${index + 1}`} className="post-form__image" />
              <button
                type="button"
