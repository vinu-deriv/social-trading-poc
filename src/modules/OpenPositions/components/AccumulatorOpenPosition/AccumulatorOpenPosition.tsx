...
import './AccumulatorOpenPosition.css';
import RandomValue from '@/components/RandomValue';
import { BaseContract } from '@/types/contract.types';

type AccumulatorOpenPositionProps = BaseContract & {
  onSell: (id: string) => void;
};

const AccumulatorOpenPosition: React.FC<AccumulatorOpenPositionProps> = ({
  contractId,
  symbol,
  stake,
  leader,
...
export default AccumulatorOpenPosition;
